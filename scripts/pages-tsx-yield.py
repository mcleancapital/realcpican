...
# File paths
excel_file = './data/tsx-dividend-yield.xlsx'
html_template = './tsx-dividend-yield/index.html'
output_html = './tsx-dividend-yield/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">S&P/TSX Dividend Yield</span>:</b> {latest_volume:,}% ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
