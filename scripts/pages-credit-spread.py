...
html_template = './credit-spread/index.html'
output_html = './credit-spread/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">High-Yield Corporate Yield - US 10 Year Treasury Rate (credit spread)</span>:</b> {latest_volume:.2f}% ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
