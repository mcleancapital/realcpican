...
# Paths for the files
excel_file = './data/home-prices.xlsx'
html_template = './home-prices/index.html'
output_html = './home-prices/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Home Prices</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
