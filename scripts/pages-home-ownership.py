...
# Paths for the files
excel_file = './data/home-ownership.xlsx'
html_template = './home-ownership/index.html'
output_html = './home-ownership/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Home Ownership Rate</span>:</b> {latest_volume:.2f}% ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
