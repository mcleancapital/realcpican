...
# Paths for the files
excel_file = './data/m2-gdp.xlsx'
html_template = './m2-gdp/index.html'
output_html = './m2-gdp/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">M2 / Nominal GDP in Canada</span>:</b> {latest_volume:.2f}% ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
