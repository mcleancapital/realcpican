...
# Paths for the files
excel_file = './data/energy.xlsx'
html_template = './energy/index.html'
output_html = './energy/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Petroleum Consumption</span>:</b> {latest_volume:,}M barrels per day ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
