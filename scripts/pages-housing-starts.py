...
# Paths for the files
excel_file = './data/housing-starts.xlsx'
html_template = './housing-starts/index.html'
output_html = './housing-starts/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Housing Starts</span>:</b> {latest_volume:,}K ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
