...
# Paths for the files
excel_file = './data/confidence.xlsx'
html_template = './confidence/index.html'
output_html = './confidence/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">OECD Composite Leading Indicator for Canada</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
