...
EXCEL_FILE_PATH = './data/gdp.xlsx'

# URL and headers
URL = "https://ycharts.com/indicators/canada_gdp"
HEADERS = {
...
def fetch_recent_cpi_data(url):
    ...
    try:
        ...
        recent_value = float(parts[0].replace("T", ""))  # Extract TSI value
        recent_date_str = parts[2].replace("CAD for ", "")  # Clean up the date
