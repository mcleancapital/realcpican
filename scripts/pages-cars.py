...
# Paths for the files
excel_file = './data/cars.xlsx'
html_template = './cars/index.html'
output_html = './cars/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Vehicle Sales Volume</span>:</b> {latest_volume:,}K ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
