...
# Paths for the files
excel_file = './data/catsa.xlsx'
html_template = './catsa/index.html'
output_html = './catsa/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Airports Passenger Volume</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
