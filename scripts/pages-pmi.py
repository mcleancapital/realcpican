...
# Paths for the files
excel_file = './data/pmi.xlsx'
html_template = './pmi/index.html'
output_html = './pmi/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Ivey PMI</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
