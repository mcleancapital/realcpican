...
# URL and headers
URL = "https://ycharts.com/indicators/canada_petroleum_consumption"
HEADERS = {
...
def fetch_recent_cpi_data(url):
    ...
    try:
        ...
        recent_value = float(parts[0].replace("M", ""))  # Extract TSI value
        recent_date_str = parts[2].replace("bbl/d for ", "")  # Clean up the date
