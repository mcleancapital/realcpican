...
html_template = './gdp/index.html'
output_html = './gdp/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada GDP</span>:</b> {latest_volume:,}T ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
