...
# Paths for the files
excel_file = './data/health.xlsx'
html_template = './health/index.html'
output_html = './health/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Healthcare Expenditures</span>:</b> {latest_volume:,}B ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
