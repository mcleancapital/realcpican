...
# Paths for the files
excel_file = './data/food.xlsx'
html_template = './food/index.html'
output_html = './food/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Food & Beverage Sales</span>:</b> {latest_volume:,}B ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
