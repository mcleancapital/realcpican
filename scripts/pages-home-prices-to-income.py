...
# Paths for the files
excel_file = './data/home-prices-to-income.xlsx'
html_template = './home-prices-to-income/index.html'
output_html = './home-prices-to-income/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Home Prices / Household Income</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
