...
# Paths for the files
excel_file = './data/transportation.xlsx'
html_template = './transportation/index.html'
output_html = './transportation/index.html'
...
html_content = re.sub(
    ...
    f"<b>Current <span class=\"currentTitle\">Canada Transportation and Warehousing Jobs Index</span>:</b> {latest_volume:,} ({formatted_percentage_change} vs last year)",
    html_content,
    flags=re.DOTALL
)
